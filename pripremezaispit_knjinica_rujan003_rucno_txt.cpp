...
void unosPodataka(){
  ...
  cout<<"Unesi sifru knjige\n";
    cin>>posudba[unos].sifraKnji;
        ...
        cout<<"Unesite broj dana posudbe\n";
...
do{
  ...
  cout<<"3. Pregled posuðenih knjiga\n";
  cout<<"4. Vraæanje knjige i Naplata zakasnine\n";
